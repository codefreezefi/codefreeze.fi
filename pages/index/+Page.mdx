...
import CodeOfConduct from "../../content/code-of-conduct.mdx";

## Prepare for your last commit
...
<section class="infoBox">
  ...
  <div class="text">
    ...
    <p>
      <strong>What</strong>
      <br />A family-friendly 7-day unconference that feels like a vacation.
    </p>
  </div>
  <div class="photo">
...
- For [single bed room](https://www.kiilopaa.fi/en/accommodation/hotel-niilanpaa): 947 € / room / 7 nights
- For [double](https://www.kiilopaa.fi/en/accommodation/hotel-niilanpaa) 1.313 € / room / 7 nights
- For a [wilderness cabin](https://www.kiilopaa.fi/en/accommodation/cabins) 925 € / cabin / 7 nights
- For a [log cabin](https://www.kiilopaa.fi/en/accommodation/cabins) (very suitable for families): 1114 € / cabin / 7 nights

And meals

- Full board package (breakfast, lunch, dinner) for 380 € / person / 7 nights
...
For every single flight arriving at Ivalo, there is a [bus connection from the Ivalo airport to Kiilopää](https://liput.matkahuolto.fi/connectionlist?lang=en&departurePlaceId=p2120&arrivalPlaceId=s1963).
...
_More information about [the smoke sauna in Kiilopää](https://www.kiilopaa.fi/en/kuurakaltio-savusauna-ja-uintipaikka)._
...
These values are inspired by SoCraTes Germany [socrates-conference.de/values](https://socrates-conference.de/values).
